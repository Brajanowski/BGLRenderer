...
namespace BGLRenderer
{
    namespace MaterialSettings
    {
        ...
        static constexpr std::string_view programVertexShader = "vertex_shader";
        static constexpr std::string_view programFragmentShader = "fragment_shader";
    ...
    {
        std::shared_ptr<OpenGLMaterial> material = std::make_shared<OpenGLMaterial>(name, MaterialType::opaque, MaterialTag::pbr);
