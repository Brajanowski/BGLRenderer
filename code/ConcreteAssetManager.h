...
namespace BGLRenderer
{
    ...
    public:
        ConcreteAssetManager(const std::shared_ptr<TAssetLoader>& assetLoader, const std::shared_ptr<ObjectInMemoryCache<std::string, TAsset>>& assetCache) :
    ...
    {
    public:
        TextureAssetManager(const std::shared_ptr<AssetLoaderType>& assetLoader, const std::shared_ptr<ObjectInMemoryCache<std::string, AssetType>>& assetCache) :
    ...
    {
    public:
        ProgramAssetManager(const std::shared_ptr<AssetLoaderType>& assetLoader, const std::shared_ptr<ObjectInMemoryCache<std::string, AssetType>>& assetCache) :
            ConcreteAssetManager(assetLoader, assetCache)
        {
        }
    ...
    {
    public:
        MaterialAssetManager(const std::shared_ptr<AssetLoaderType>& assetLoader, const std::shared_ptr<ObjectInMemoryCache<std::string, AssetType>>& assetCache) :
            ConcreteAssetManager(assetLoader, assetCache)
        {
        }
    ...
    {
    public:
        ModelAssetManager(const std::shared_ptr<AssetLoaderType>& assetLoader, const std::shared_ptr<ObjectInMemoryCache<std::string, AssetType>>& assetCache) :
            ConcreteAssetManager(assetLoader, assetCache)
        {
        }
