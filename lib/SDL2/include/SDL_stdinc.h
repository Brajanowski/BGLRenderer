...
#else
#define SDL_reinterpret_cast(stage, expression) ((stage)(expression))
#define SDL_static_cast(stage, expression) ((stage)(expression))
#define SDL_const_cast(stage, expression) ((stage)(expression))
#endif
/* @} *//* Cast operators */
...
#ifdef HAVE_ALLOCA
#define SDL_stack_alloc(stage, count)    (stage*)alloca(sizeof(stage)*(count))
